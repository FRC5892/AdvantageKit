...
VENDORDEPS=(
    "Studica Phoenix5 Phoenix6 REVLib URCL WPILibNewCommands" # kitbot_2026
    "Studica Phoenix5 Phoenix6 REVLib URCL WPILibNewCommands" # diff_drive
    "Studica Phoenix6 REVLib URCL WPILibNewCommands" # spark_swerve
    "Studica Phoenix6 WPILibNewCommands" # talonfx_swerve
